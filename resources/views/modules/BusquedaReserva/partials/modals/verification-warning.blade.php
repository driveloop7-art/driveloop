...
@if (Auth::check())
    <x-modal xs:max-w-xs name="verification-warning" title="Documentos No Verificados" maxWidth="lg" focusable>
        <div class="p-6 text-center">
            <h2 class="text-lg font-medium text-gray-900">
                ¡Atención!
            </h2>
            <p class="mt-4 text-sm text-gray-600 mb-6">
                Para continuar en el proceso, es necesario que sus documentos estén aprobados.
            </p>

<x-page>
    <div class="max-w-7xl mx-20 px-2 py-2">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-500 text-sm">Complete toda la información para completar el proceso de renta del vehículo.</p>
        </div>
        ...
        <style>
            ...
            #payment-toggles .bg-gray-50:has(.is-active-marker) {
                border-color: #ef4444 !important; /* dl color */
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <x-toggle>
                    ...
                    <x-toggle>
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="flex items-center gap-4">
                                    <div class="flex gap-1">
                                         <div class="h-6 w-10 bg-white border border-gray-200 rounded flex items-center justify-center">
                                            <div class="h-3 w-3 bg-red-500 rounded-full opacity-60 -mr-1"></div>
                                            <div class="h-3 w-3 bg-yellow-400 rounded-full opacity-60"></div>
                                        </div>
                                        <div class="h-6 w-10 bg-white border border-gray-200 rounded flex items-center justify-center text-[10px] font-bold text-blue-800 italic">VISA</div>
                                    </div>
                                    <div class="text-left">
                                        <span class="block font-bold text-gray-800 text-sm">Tarjetas de crédito o débito</span>
                                        <span class="block text-xs text-gray-500 leading-tight">Paga con tarjeta de crédito Visa o Mastercard.</span>
                                    </div>
                                </div>
                                {{-- Custom Radio Button --}}
                        ...
                        <div class="mt-2 space-y-4">
                            ...
                            <div class="flex items-center gap-2 mt-2">
                                <span class="text-xs text-gray-500">¿Quieres guardar este método de pago para alquileres futuros?</span>
                            </div>
                            <div class="flex items-center gap-4">
                                ...
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="save_card" value="no" class="text-dl focus:ring-dl" checked>
                    ...
                    <x-toggle>
                        <x-slot:title>
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="flex items-center gap-4">
                                    <div class="h-8 w-8 bg-blue-900 rounded-full flex items-center justify-center text-[8px] font-bold text-white overflow-hidden shrink-0 shadow-sm relative">
                                        <div class="absolute inset-0 bg-gradient-to-br from-blue-700 to-blue-900"></div>
                                        <span class="relative z-10 font-sans italic tracking-tighter scale-90">pse</span>
                                    </div>
                                    <div class="text-left">
                                        <span class="block font-bold text-gray-800 text-sm">Transferencia Bancaria</span>
                                        <span class="block text-xs text-gray-500 leading-tight">Paga mediante transferencias bancarias locales.</span>
                                    </div>
                                </div>
                                <div class="w-5 h-5 rounded-full border border-gray-300 flex items-center justify-center transition-colors"
                                     :class="active === $id('item') ? 'border-dl bg-dl' : 'bg-white'">
                        ...
                        <div class="mt-2 space-y-4">
                            ...
                            <x-input type="text" name="pse_bank" label="Selecciona el banco" /> <!-- Simulate select with input for now -->
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="save_pse" value="no" class="text-dl focus:ring-dl" checked>
                                    <span class="text-xs text-gray-600">No</span>
                                </label>
                            </div>
                        </div>
                    ...
                    <x-toggle>
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="flex items-center gap-4">
                                    <div class="h-8 w-12 flex items-center justify-start">
                                        <span class="text-lg font-bold text-pink-600 tracking-tighter">'Nequi</span>
                                    </div>
                                    <div class="text-left">
                                        <span class="block font-bold text-gray-800 text-sm">Nequi</span>
                                        <span class="block text-xs text-gray-500 leading-tight">Pagar con fondos del monedero Nequi.</span>
                                    </div>
                                </div>
                                <div class="w-5 h-5 rounded-full border border-gray-300 flex items-center justify-center transition-colors"
                                     :class="active === $id('item') ? 'border-dl bg-dl' : 'bg-white'">
                        ...
                        <div class="mt-2 space-y-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="save_nequi" value="no" class="text-dl focus:ring-dl" checked>
                                    <span class="text-xs text-gray-600">No</span>
                                </label>
                            </div>
                        </div>
            ...
            <div class="border border-gray-200 rounded-none p-6 bg-white shadow-sm flex flex-col items-center text-center">
                 {{-- Dates --}}
                <div class="w-full flex justify-between border-b border-gray-100 pb-4 mb-6">
                    <div class="text-left border-r border-gray-100 pr-4 w-1/2">
                        <span class="block text-[10px] text-gray-400 uppercase tracking-wide">Fecha y hora de recogida</span>
                    ...
                    <div class="text-left pl-4 w-1/2">
                         <span class="block text-[10px] text-gray-400 uppercase tracking-wide">Fecha y hora de entrega</span>
                        <div class="flex items-center text-xs text-gray-600 font-medium mt-1">
                ...
                <div class="mb-6 relative w-full h-40 flex items-center justify-center">
                     <img src="https://placehold.co/600x400/red/white?text=Toyota+RAV4" alt="Toyota RAV4" class="max-h-full object-contain">
                </div>
                ...
                <div class="w-full">
                    <x-button type="tertiary" class="w-full !border-dl !text-dl hover:!bg-dl hover:!text-white uppercase font-bold py-3">
                        CONTINUAR
                    </x-button>
                </div>
